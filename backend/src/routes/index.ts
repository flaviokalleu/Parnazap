...
import declinioRoutes from './declinioRoutes';
import colaboradorRoutes from './colaboradorRoutes';
import ordemServicoRoutes from "./ordemServicoRoutes"; // Importar a rota de ordem de serviço
...
routes.use('/declinio', declinioRoutes); 
routes.use(colaboradorRoutes); // Adicione esta linha
routes.use(ordemServicoRoutes); // Usar a rota de ordem de serviço
