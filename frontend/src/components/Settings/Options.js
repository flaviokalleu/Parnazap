...
const useStyles = makeStyles((theme) => ({
  ...
  tab: {
    backgroundColor: theme.palette.options,  //DARK MODE ParnaZap - Plataforma de MutiAtendimento//
    borderRadius: 4,
    width: "100%",
    "& .MuiTab-wrapper": {
      color: theme.palette.fontecor,
    },   //DARK MODE ParnaZap - Plataforma de MutiAtendimento//
...
export default function Options(props) {
  ...
  // recursos a mais da ParnaZap - Plataforma de MutiAtendimento
  ...
  useEffect(() => {
    if (Array.isArray(settings) && settings.length) {
	  ...
	  {/*ParnaZap - Plataforma de MutiAtendimento SAUDAÇÃO*/}
